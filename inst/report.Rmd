...
```
*Figure 2: Estimated annual probability of occupancy. Solid line shows estimated mean breeding latitude in each year. Long dash lines show the estimated 25th and 75th occupancy percentiles (i.e., core breeding range). Short dash lines show the estimated 5th and 95th occupancy percentiles (i.e., range limits)*
